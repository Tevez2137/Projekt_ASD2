            ...
            try
            {
                ...
                if (otoczka.size() >= 2)
                {
                    ...
                    for (const auto &p : otoczka)
                    {
                        ...
                        {
                            if (pp.first.x == p.x && pp.first.y == p.y)
                            {
                                origKopalniaID = pp.second;
                                break;
                            }
                        }
                        int useID = 1000 + idx;
                    ...
                    if (dowodcaID >= 1000)
                    {
                        ...
                        if (idx_do >= 0 && idx_do < (int)chosenPerIdx.size())
                            realCandidate = chosenPerIdx[idx_do];
                    }
                    else
                    {
